...
\begin{center}
    \begin{longtable}{|p{1.5cm}|p{2.5cm}|p{2.5cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|}
        ...
        1.03 & Test Add supplier button works & This should take the user to the add information page and close the results window. & Click the add supplier button & Normal & The add information page should display &  &  \\ \hline
       	...
       	1.18 & Test to see if the update comments button works & Should update the comments stored in the database & Click the update comment button & normal & The information written in the line edits should be added to the database, replacing the data already there & & \\ \hline
       	1.19 & Check to see if the delete comment button works & Should delete the selected data from the database & click the delete comment button & normal & The comment and all information regarding the comment should be removed from the database & & \\ \hline
       	1.20 & Check to see if the delete information button works & This should delete all of the information relevant to the selected supplier & click the delete supplier button & normal & the supplier selected and all relevant data should be removed from the database & & \\ \hline
       	3.01 & Test to see if the supplier data is added to the database & The supplier's company name, owner name, address, email address, telephone number and website address should all be added to the database under one supplier & Supplier information & normal & Added to the supplier table & & \\ \hline
       	3.02 & Check to see if the supplier data is updated & Once the user has entered new information, the present data should be deleted and the new data should be stored in the space & Supplier information & normal & Updated the information in the supplier table & & \\ \hline
       	3.03 & Test to see if the supplier data is deleted & Once confirmed by the user, a specific supplier should be removed from the database & supplier information & normal & Deleted from the supplier table & & \\ \hline
       	3.04 & Test to see if the parts data is added to the database & The parts should all be added to the parts table with their corresponding prices & Parts information & normal & Added to the parts table & & \\ \hline
       	3.05 & Check to see if the parts data is updated & Once the user has entered new information, the present data should be deleted and the new data should be stored in the space & Parts information & normal & Updated the information in the parts table & & \\ \hline
       	...
       	3.07 & Test to see if the comments data is added to the database & The comment and rating should all be added to the database under one comment & Comment information & normal & Added to the comments table & & \\ \hline 
       	3.08 & Check to see if the comment data is updated & Once the user has entered new information, the present data should be deleted and the new data should be stored in the space & Comments information & normal & Updated the information in the Comments table & & \\ \hline
       	3.09 & Test to see if the comments data is deleted & Once confirmed by the user, a specific comment and rating should be removed from the database & comment information & normal & Deleted from the comments table & & \\ \hline
       	4 & Verify the
